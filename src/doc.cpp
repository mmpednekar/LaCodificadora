...
string commands[8] = {"blacksmith","schedule","send prescription","proceed","yes","no","shutdown","stop"};
...
time_repeat:
            ...
            {
                speechmodule.textToSpeech("Can you repeat again");
                goto time_repeat;
            }
